  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(notices.value, (notice) => {
        _push(`<li class="bg-white p-2 rounded-lg shadow"><h3 class="text-md font-semibold text-gray-600">${ssrInterpolate(notice.title)}</h3><p class="text-sm text-gray-700">${ssrInterpolate(notice.content)}</p></li>`);
      });
      _push(`<!--]--></ul></div>`);
    };
  }
...
//# sourceMappingURL=index-B_w9AGHW.mjs.map
