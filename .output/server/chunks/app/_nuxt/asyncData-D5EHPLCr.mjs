import { o as asyncDataDefaults, j as useRuntimeConfig, n as useNuxtApp, c as createError } from '../server.mjs';
import { w as withLeadingSlash, j as joinURL, x as withoutTrailingSlash, N as withBase, z as hash } from '../../nitro/node-server.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-CtkYHHDp.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CgcMjeeD.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=asyncData-D5EHPLCr.mjs.map
