import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './asyncData-D5EHPLCr.mjs';
import { k as useState, j as useRuntimeConfig, a as __nuxt_component_0$1 } from '../server.mjs';
import { z as hash } from '../../nitro/node-server.mjs';
import { a as useContentPreview } from './preview-CtkYHHDp.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CgcMjeeD.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-DhCzyn0j.mjs.map
