import { f as useAppConfig, m as mergeConfig, d as appConfig, g as __nuxt_component_0$2, e as useUI, _ as _export_sfc } from '../server.mjs';
import __nuxt_component_0$3 from './Icon-CCYFKLuS.mjs';
import { defineComponent, computed, useSSRContext, toRef, getCurrentInstance, inject, onUnmounted, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
...
export { __nuxt_component_0$1 as _, __nuxt_component_0 as a, useInjectButtonGroup as u };
//# sourceMappingURL=Button-ZPNOzfvf.mjs.map
